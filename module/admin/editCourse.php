                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">   
                                            <input type="hidden"  name="classId" value="<?php echo $classes['classId']; ?>" >   
                                            <input type="hidden" name="token" value="<?php echo Token::generate('updateCourse');?>">                                        
                                            <button type="submit" name="updateCourse" value="updateCourse" class="btn btn-primary">Update Course Subject</button>
                                        </div> 
                                    </div>
                                </div>  
                            </form>
